...
//Autor: https://github.com/nopnop2002/esp-idf-ssd1306
//Actualizaciones: Ivan Vargas A. ( INTECX S.A.C. => https://intecx.com.pe )
...
//Direccion y frecuencia del dispositivo
#define SSD1306_DEV_ADDR      0x3C
#define SSD1306_DEV_FREQ_HZ   400000  /*!< I2C clock of SSD1306 can run at 400 kHz max. */
...
//Funtions
void ssd1306_init(i2c_master_bus_handle_t master_bus, SSD1306_t *dev, uint8_t addr, int width, int height);
...
//I2C
esp_err_t ssd_i2c_init(i2c_master_bus_handle_t master_bus_handle, SSD1306_t *dev, uint8_t addr, int width, int height);
